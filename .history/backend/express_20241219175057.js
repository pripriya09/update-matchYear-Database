...
// const checkSubmissionSSNformate =(user) =>{
//     if(user.submission_type === "online" && (user.enroll == true || user.ahap == true)){
...
//   }
   ...
   {/* <td data-label="SSN">{checkSubmissionSSNformate(user)}</td> */}